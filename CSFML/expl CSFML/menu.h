...
void initButton(); //init du menu
void updateLightBtn(sfRenderWindow* window, sfVector2i mousePosition); //effets du menu
void updateButton(sfRenderWindow* window, sfVector2i mousePosition); 
void displayButton(sfRenderWindow* window);
void destroyButton();
void show_option_panel(sfRenderWindow* window);//le panel 
